I want to deploy a full node of Base L2 on this system. Use /mnt/viper1 as the data directory. Use plan mode and read
  the base docs throughly to find all the options you need to do to make it fast. You also need to find and install a
  ...
  unneeded features, the only important thing is querying blocks, transactions and logs. Save this very query into the
  RPC_NODE.md which I will use for other chain nodes as well
